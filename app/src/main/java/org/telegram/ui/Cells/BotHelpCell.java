...
public class BotHelpCell extends View {
    ...
    public BotHelpCell(Context context) {
        ...
        textPaint = new MyTextPaint(Paint.ANTI_ALIAS_FLAG);
    ...
    public void setText(String text) {
        ...
        stringBuilder.setSpan(new TypefaceSpan(AndroidUtilities.getTypeface("fonts/"+ Setting.get(Setting.FONT_FAMILY_LABLE, Setting.FONT_FAMILY_VALUE))), 0, help.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
