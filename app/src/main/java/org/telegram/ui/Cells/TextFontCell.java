...
public class TextFontCell extends FrameLayout {
    ...
    public TextFontCell(Context context, String font) {
        super(context);
        ...
        textView.setTypeface(AndroidUtilities.getTypeface("fonts/"+font));
