...
public class ChatMediaCell extends ChatBaseCell {
    ...
    public ChatMediaCell(Context context) {
        ...
        if (infoPaint == null) {
            infoPaint = new MyTextPaint(Paint.ANTI_ALIAS_FLAG);
            infoPaint.setTextSize(AndroidUtilities.dp(12));

            namePaint = new MyTextPaint(Paint.ANTI_ALIAS_FLAG);
            ...
            locationTitlePaint = new MyTextPaint(Paint.ANTI_ALIAS_FLAG);
            ...
            locationAddressPaint = new MyTextPaint(Paint.ANTI_ALIAS_FLAG);
