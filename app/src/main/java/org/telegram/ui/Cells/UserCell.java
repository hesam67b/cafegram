            ...
            if (currentUser.bot) {
                ...
                if(currentUser.id == UserConfig.getClientUserId()) {
                    ...
                    if(Setting.get(Setting.HIDDEN_MODE_STATUS_LABLE, Setting.HIDDEN_MODE_STATUS_VALUE)) {
                        statusTextView.setText(LocaleController.getString("Hidden", R.string.Hidden));
                    } else {
                        statusTextView.setText(LocaleController.getString("Online", R.string.Online));
                    }
                }
                else if (currentUser.id == UserConfig.getClientUserId() || currentUser.status != null && currentUser.status.expires > ConnectionsManager.getInstance().getCurrentTime() || MessagesController.getInstance().onlinePrivacy.containsKey(currentUser.id)) {
                    statusTextView.setTextColor(statusOnlineColor);
                    statusTextView.setText(LocaleController.getString("Online", R.string.Online));
                } else {
                    statusTextView.setTextColor(statusColor);
