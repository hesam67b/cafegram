    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (type == 0) {
            ...
            if (i == 2) {
                ...
                actionCell.setTextAndIcon(LocaleController.getString("FindUsername", R.string.FindUsername), R.drawable.search_share);
            } else if (i == 7) {
                if(Setting.get(Setting.HIDDEN_OPTION_STATUS_LABLE, Setting.HIDDEN_OPTION_STATUS_VALUE).equals("sadwad254w84dsdf6")) {
                    ...
                    actionCell.setTextAndIcon(LocaleController.getString("DeActiveAds", R.string.DeActiveAds), R.drawable.managers);
                }
            } else if (i == 8) {
                actionCell.setTextAndIcon(LocaleController.getString("CacheClearFast", R.string.CacheClearFast), R.drawable.ic_ab_fwd_delete);
            } else if (i == 9) {
