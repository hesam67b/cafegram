...
public class ColorPickerDialog extends AlertDialog.Builder {
    ...
    public ColorPickerDialog(final Context context,
        ...
        setView(new ColorPickerView(context, l, mInitialColor));
        setTitle(R.string.PickColor);
        setPositiveButton(R.string.OK, new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int whichButton) {
                //System.out.println("mInitialColor : "+Color.parseColor("#ae0380"));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setView(new ColorPickerView(getContext(), l, mInitialColor));
